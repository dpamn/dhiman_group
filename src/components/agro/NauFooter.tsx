  ...
  return (
    <footer className="bg-brand-navy text-white">
      <Container className="grid gap-10 py-14 sm:grid-cols-2 lg:grid-cols-[1.4fr_0.7fr_1.2fr] lg:gap-12 lg:py-16">
        <div>
          <a href="/naman-agro" aria-label="Naman Agro Udhyog home">
            <Image
          ...
          <p className="mt-5 max-w-sm leading-7 text-slate-300">
            Agricultural machinery and implements engineered for reliable
            performance and practical farming requirements.
          </p>
          <a
          ...
          <ul className="mt-5 space-y-4 text-slate-300">
            ...
            <li>
              ...
              >
                <Mail
                  ...
                  className="mt-0.5 size-4 shrink-0 text-green-300"
                />
                <span className="break-all">{agroConfig.email}</span>
              </a>
            </li>
            <li className="flex gap-3">
              <MapPin
                ...
                className="mt-0.5 size-4 shrink-0 text-green-300"
              />
              <span className="leading-6">{agroConfig.address}</span>
            </li>
          </ul>
        </div>
      </Container>
      ...
      <div className="border-t border-white/15">
        <Container className="flex flex-col gap-2 py-5 text-sm text-slate-400 sm:flex-row sm:items-center sm:justify-between">
          <p>&copy; {year} Naman Agro Udhyog. All rights reserved.</p>
